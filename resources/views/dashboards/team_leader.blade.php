<x-app-layout>
    ...
    @else
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-6 col-lg-3">
                <div class="card glass-card p-3 border-0 h-100">
                    <div class="text-secondary font-monospace small mb-1">PENDING FOLLOW-UPS</div>
                    <div class="fs-2 fw-bold text-danger">{{ $pending_followups }}</div>
                </div>
            </div>
            <div class="col-6 col-lg-3">
                <div class="card glass-card p-3 border-0 h-100">
        ...
        <div class="card glass-card border-0 p-4">
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle datatable">
                    ...
                    <tbody>
                        @forelse($today_activities as $act)
                            <tr>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center text-muted py-3">No activities logged today.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
