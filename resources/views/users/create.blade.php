<x-app-layout>
    <div class="mb-4">
        ...
        <h2 class="fw-bold mb-1">Register Employee</h2>
        <p class="text-secondary small mb-0">Create new user credentials, Spatie permissions, and configure their active profile.</p>
    </div>
        ...
        <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    ...
                    <input type="text" name="name" class="form-control" value="{{ old('name') }}" required placeholder="e.g. David Miller">
                </div>

                <div class="col-12 col-md-6 col-lg-4">
                    <label class="form-label small fw-semibold">Email Address *</label>
                    <input type="email" name="email" class="form-control" value="{{ old('email') }}" required placeholder="david@smeclabs.com">
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-6">
                    ...
                    <input type="password" name="password" class="form-control" required placeholder="Minimum 8 characters" autocomplete="new-password">
                </div>

                <div class="col-12 col-md-6 col-lg-6">
                    <label class="form-label small fw-semibold">Confirm Password *</label>
                    <input type="password" name="password_confirmation" class="form-control" required placeholder="Re-enter password" autocomplete="new-password">
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-6">
                    ...
                    <input type="text" name="employee_id" class="form-control" value="{{ old('employee_id') }}" required placeholder="e.g. SMEC-2026-004">
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-6">
                    ...
                    <input type="number" name="target" class="form-control" value="{{ old('target', 10) }}" placeholder="e.g. 10" min="0">
                </div>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <select name="status" class="form-select" required>
                        <option value="active" {{ old('status') === 'active' ? 'selected' : '' }}>Active (Can log in)</option>
                ...
                <div class="col-12 d-flex justify-content-end gap-2 border-top pt-4 mt-4">
                    ...
                    <button type="submit" class="btn btn-primary btn-rounded px-4 py-2.5 fw-semibold"><i class="bi bi-save me-1"></i> Register Account</button>
                </div>
            </div>
        </form>
    </div>
